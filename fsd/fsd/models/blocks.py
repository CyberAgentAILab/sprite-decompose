# Original source: https://github.com/vye16/deformable-sprites/blob/main/models/blocks.py
import torch
...
class DoubleConvBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(in_planes, mid_planes, kernel_size=kernel_size, padding=padding, stride=s1)
        self.conv2 = nn.Conv2d(mid_planes, planes, kernel_size=kernel_size, padding=padding, stride=s2)
